...
GPG_KEY='{{PROJECT_BACKUP_GPG_KEY}}'
GPG_PW='{{PROJECT_BACKUP_GPG_PW}}'
...
# Allow duply to continue to backup even if the host changes. The host could
# change due to a container recreate
